...
@Component
public class CrcHash extends BaseHash implements Hash {
	int crctab[] = { 0x00000000, 0x77073096, 0xee0e612c, 0x990951ba,
	...
	public void build_table() {
	  ...
	  for (i=0; i<256; ++i) {
	    ...
	    j = (j>>1) ^ (((j&1) == 1) ? 0xedb88320 : 0); 
	    j = (j>>1) ^ (((j&1) == 1) ? 0xedb88320 : 0); 
	    System.out.println(String.format("0x%.8lx, ", j));
